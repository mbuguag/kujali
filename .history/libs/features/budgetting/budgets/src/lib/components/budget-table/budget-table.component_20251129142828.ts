...
import { FlexLayoutModule } from '@angular/flex-layout'; // Needed for fxLayout
...
@Component({
  ...
  imports: [
    CommonModule, 
    MatTableModule, MatPaginatorModule, MatSortModule, MatDialogModule, MatButtonModule, MatTooltipModule,
    FlexLayoutModule, MultiLangModule
  ],
})

export class BudgetTableComponent implementsAfterViewInit {
