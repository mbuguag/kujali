// Assume these imports from the project's utility libs
import { FunctionHandler, HandlerToolkit } from '@iote/cqrs/functions';
// Or similar path, based on actual project structure

import { AddNoteToBudgetCommand } from './add-note.command';

// Since the command is a write operation, the result is typically 'void'
// You should use the actual imported names from the project (e.g., 'AddNoteToBudgetResult')
